    ...
    match lang {
        "rust" | "rs" => (
            &[
                ...
                "crate", "async", "await", "loop", "while", "break", "continue", "type", "const",
                "static", "unsafe", "extern", "dyn", "ref", "move",
            ],
            &[
                "i8", "i16", "i32", "i64", "i128", "isize", "u8", "u16", "u32", "u64", "u128",
                "usize", "f32", "f64", "bool", "char", "str", "String", "Vec", "Option", "Result",
                "Ok", "Err", "Some", "None", "Box", "Arc", "Rc", "HashMap", "HashSet", "BTreeMap",
                "BTreeSet", "true", "false",
            ],
        ),
        ...
        "python" | "py" => (
            &[
                ...
                "pass", "yield", "lambda", "and", "or", "not", "in", "is", "global", "nonlocal",
        ...
        "sh" | "bash" | "shell" | "zsh" => (
            &[
                "if", "then", "fi", "else", "elif", "for", "in", "do", "done", "while", "until",
                "case", "esac", "function", "return", "exit", "break", "continue", "export",
                "local", "readonly", "source", ".", "echo", "printf", "read", "shift", "set",
                "unset",
            ],
            &[
                "true", "false", "$", "${", "$(", "||", "&&", ";;", "2>", "1>", ">>", "<<", "pipe",
...
fn flush_token(token: &mut String, spans: &mut Vec<Span<'static>>, kws: &[&str], types: &[&str]) {
    if token.is_empty() {
        return;
    }
